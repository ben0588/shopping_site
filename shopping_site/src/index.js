...
import { AuthProvider } from './components/auth/AuthContext' // 會員驗證環境
import Skeleton, { SkeletonTheme } from 'react-loading-skeleton' // 全域改變 skeleton 樣式
import { ProductProvider } from './components/payment/ProductContext'
...
root.render(
    <HashRouter>
        <SkeletonTheme baseColor='#dfe6e9' highlightColor='#b2bec3'>
            <ThemeProvider>
                <AdminProvider>
                    <ProductProvider>
                        <AuthProvider>
